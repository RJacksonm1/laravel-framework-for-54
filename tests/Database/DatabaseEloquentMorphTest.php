...
class DatabaseEloquentMorphTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFindOrNewMethodFindsModel()
    {
        ...
        $this->assertInstanceOf('Illuminate\Database\Eloquent\Model', $relation->findOrNew('foo'));
    }
    ...
    public function testFirstOrNewMethodFindsFirstModel()
    {
        ...
        $this->assertInstanceOf('Illuminate\Database\Eloquent\Model', $relation->firstOrNew(['foo']));
    }
    ...
    public function testFirstOrCreateMethodFindsFirstModel()
    {
        ...
        $this->assertInstanceOf('Illuminate\Database\Eloquent\Model', $relation->firstOrCreate(['foo']));
    }
    ...
    public function testUpdateOrCreateMethodFindsFirstModelAndUpdates()
    {
        ...
        $this->assertInstanceOf('Illuminate\Database\Eloquent\Model', $relation->updateOrCreate(['foo'], ['bar']));
    }
